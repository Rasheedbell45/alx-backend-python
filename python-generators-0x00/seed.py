rasheedbello45@ubuntu:python-generators-0x00 % cat 0-main.py
#!/usr/bin/python3
...
rasheedbello45@ubuntu:python-generators-0x00 % ./0-main.py
...
rasheedbello45@h@ubuntu:python-generators-0x00 %
